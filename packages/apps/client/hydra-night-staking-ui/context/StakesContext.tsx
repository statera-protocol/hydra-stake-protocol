...
export function StakesProvider({ children }: { children: React.ReactNode }) {
  ...
  const addStake = async (
    ...
    if (!PROTOCOL_ADDRESS || PROTOCOL_ADDRESS == "") {
...
export function useStakes() {
  ...
  if (!context) {
    throw new Error("useStakes must be used within StakesProvider");
  }
  return context;
}
